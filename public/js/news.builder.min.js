    ...
    setTimeout(() => {
        ...
        ghB("add-picture").click(async () => {
            ...
            input.on("change", async (e) => {
                ...
                ghA(".news > img").forEach((e) => e.remove());
                ghA(".news > iframe").forEach((e) => e.remove());
                ghA(".news element").forEach((e) => e.remove());
                ghC(".news").append(element);
            });
        ...
        ghB("add-pdf").click(async () => {
            ...
            ghA(".news > iframe").forEach((e) => e.remove());
            ghA(".news element").forEach((e) => e.remove());
            ghC(".news").append(iframe);
        });

        ghB("add-btn").click(async () => {
        ...
        ghB("done").click(async () => {
            ...
            json.src = ghC(".news *:is(img, iframe)").src;
